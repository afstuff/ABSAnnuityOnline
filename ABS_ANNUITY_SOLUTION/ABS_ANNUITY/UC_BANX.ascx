<%@ Control Language="VB" AutoEventWireup="false" CodeFile="UC_BANX.ascx.vb" Inherits="UC_BANX" %>
                        ...
                        <table border="0" width="100%" class="tbl_logo_banner">
                            <tr>
                                <td align="left" colspan="1" valign="top">
                                    <img alt="Image" src="../Images/CAILogoN.jpg" style="width: 250px; height: 70px" />
                                </td>
                                <td align="right" colspan="1" valign="top">
                                    <img alt="Image" src="../Images/caibanner.jpg" style="width: 700px; height: 70px" />
                                </td>
                            </tr>
                        </table>                            
                    </td>
