...
Partial Class PRG_ANNTY_BRK_DTL
...
MyRtn_Ok:
    ...
    Protected Sub cboCustCateg_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboCustCateg.SelectedIndexChanged
