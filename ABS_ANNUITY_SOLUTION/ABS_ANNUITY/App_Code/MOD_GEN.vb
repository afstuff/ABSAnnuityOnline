...
gnGet_SN_End:
    ...
    Public Sub gnPopulate_DropDownList(ByVal pvCODE As String, ByVal pvcboDDList As DropDownList, Optional ByVal pvSQL As String = "", _
        ...
        Select Case UCase(RTrim(pvCODE))
            ...
            Case "AN_ASSURED_HELP_SP"
                ...
                objOLECmd.Parameters.Add("p02", OleDbType.VarChar, 50).Value = RTrim(pvWhere)
                objOLECmd.Parameters.Add("p03", OleDbType.VarChar, 50).Value = RTrim(pvDefault_Value)
    ...
    Public Sub gnProc_Populate_Box(ByVal pvCODE As String, ByVal pvTransType As String, ByVal pvcboList As DropDownList, Optional ByVal pvSearchValue As String = "", Optional ByVal pvOperIDValue As String = "")
        ...
        Select Case UCase(Trim(pvCODE))
            ...
            Case "AN_ASSURED_HELP_SP"
                ...
                strSQL = RTrim("SPAN_GET_INSURED_ONLINE")
                Call gnPopulate_DropDownList(pvCODE, pvcboList, strSQL, RTrim(pvSearchValue), "* select insured *", pvOperIDValue)
