                        ...
                        <table align="center" border="1">
                            <tr>
                                ...
                                <asp:Button ID="cmdSearch" Text="Search" runat="server" />
                                    <br />
                                    <asp:DropDownList ID="cbo_PfaName" CssClass="comboBx" runat="server" Style="margin-left: 0px" Width="250px" AutoPostBack="True">
                                    </asp:DropDownList>
                                </td>
                            </tr>
                        ...
                        <table align="center" border="0" cellpadding="1" cellspacing="1" class="tbl_menu_new">
                            ...
                            <tr>
                                <td align="left" nowrap colspan="4">
                                    <asp:Label ID="lblMessage" Text="Staus:" runat="server" Font-Size="Small" ForeColor="Red" Font-Bold="True"></asp:Label>
                                    &nbsp;<a id="PageAnchor_Return_Link" runat="server" class="a_return_menu" href="#" style="float: right;">Returns to Previous Page</a>
                                    &nbsp;<%=PageLinks%>&nbsp;
                            ...
                            <tr>
                                <td align="right" nowrap>
                                    <asp:Label ID="lblCustID" Enabled="false" Text="Record ID:" runat="server"></asp:Label>&nbsp;</td>
                                <td align="left" nowrap>
                                    <asp:TextBox ID="txtPfaID" Enabled="false"
                                        MaxLength="3" Width="100px" runat="server" EnableViewState="true"></asp:TextBox>
                                </td>
                                <td align="left" nowrap class="style2">
                                    <asp:Label ID="lblTBIL_PFA_CODE"
                            ...
                            <tr style="display: none;">
                                ...
                                <td align="left" nowrap>
                                    <asp:TextBox ID="txtTBIL_PFA_CATG" runat="server" Width="250px" ReadOnly="True">ANNUITY</asp:TextBox>
                                </td>
                                <td align="left" nowrap>
                            ...
                            <tr>
                                <td align="right" nowrap>
                                    <asp:Label ID="lblTBIL_PFA_DESC"
                                        Enabled="False" Text="PFA Description(NAME):" runat="server"></asp:Label></td>
                                <td align="left" nowrap>
                                ...
                                <td align="left" nowrap valign="top">
                                    <asp:Label ID="lblTBIL_PFA_DESC0"
                                        Enabled="False" Text="PFA Short Description(NAME):" runat="server"></asp:Label></td>
                                <td align="left" nowrap valign="top">
                            ...
                            <tr>
                                <td align="right" nowrap>
                                    <asp:Label ID="lblTBIL_PFA_BRANCH"
                            ...
                            <tr>
                                <td align="right" nowrap>
                                    <asp:Label ID="lblTBIL_PFA_BRANCH0"
                            ...
                            <tr>
                                <td align="right" nowrap>
                                    <asp:Label ID="lblTBIL_PFA_BRANCH2" Enabled="False"
                                        Text="Phone 1:" runat="server"></asp:Label></td>
                                <td align="left" nowrap>
                                    <asp:TextBox ID="txtTBIL_PFA_PHONE1" runat="server" Width="250px"></asp:TextBox>
                                </td>
                                <td align="left" nowrap>
                                    <asp:Label ID="lblTBIL_PFA_BRANCH3" Enabled="False"
                                        Text="Phone 2:" runat="server"></asp:Label>
                                </td>
                                <td align="left" nowrap>
