<%@ page language="VB" autoeventwireup="false" inherits="LoginP, App_Web_qkk2jm9h" %>
        ...
        <tr>
            <td align="left" valign="top" class="td_login_left" style="display:block;">
                <div align="center" style=" border: 1px solid #c0c0c0; display: none;" >
                    <img alt="" src="Images/Family.jpg" style="width: 300px; height: 180px;" />
                </div>
            ...
            <td align="left" valign="top" class="td_login_right">
	            <table align="center" border="0" cellspacing="0" class="TBL_LOGIN">
                    ...
                    <tr>
                        <td align="left" colspan="3" valign="top">&nbsp;Please Login with your valid User ID and Password</td>
                    ...
                    <tr>
    	                <td colspan="2" rowspan="6" align="center" valign="top">
    	                    <asp:Image ID="Image1" ImageUrl="~/Images/img4.jpg" runat="server" 
                    ...
                    <tr>
                        <td colspan="2" style="display: block;">&nbsp;&nbsp;</td>
                    </tr>
